...
public class Analogdisplay extends View {

    public static final int Maxim = 300;
    public static final float Topline = 0.0f;
    public static final float LEFT = 0.0f;
    public static final float RIGHT = 1.0f;
    public static final float BOTTOM = 1.0f;
    public static final float CENTER = 0.5f;

    public static final boolean AussereSchatten = true;
    public static final boolean ShowOuterBorder = true;
    public static final boolean ShowOuterRim = true;
    public static final boolean ShowInerRim = true;
    public static final boolean ShowNedel = true;
    public static final boolean ShowScale = false;
    public static final boolean ShowRanges = true;
    public static final boolean ShowText = false;
    public static final boolean StandarsShowRangeValues = false;

    public static final float OuterShadomWidth = 0.03f;
    public static final float OuterBorderWdith = 0.04f;
    public static final float OuterRimWidth = 0.05f;
    public static final float InnerRimWidth = 0.06f;
    public static final float InnerRimBorderWidth = 0.005f;

    public static final float NedelWidth = 0.025f;
    public static final float NedleHeigh = 0.32f;
    public static final int InnercircelColor = Color.rgb(1, 1, 226);
    public static final int OuterCircleColor = Color.rgb(205, 231, 132);


    public static final float ScalePosition = 0.015f;
    public static final float ScaleStartValue = 0.0f;
    public static final float ScaleEndValue = 100.0f;
    public static final float ScaleStartAngle = 60.0f;
    public static final int ScaleDivision = 10;
    public static final int ScaleSubdivision = 5;
    ...
    public static final int[] RangeColors = {Color.WHITE};

    public static final int TextShadowColor = Color.argb(100, 0, 0, 0);
    public static final int TextValueColor = Color.WHITE;
    public static final int TextUnitColor = Color.WHITE;
    public static final float TextValueSize = 0.3f;
    public static final float TextUnitSitze = 0.1f;
    private static final float[] StandardRangeValue = new float[]{0.0f, 100.0f, 200.0f, 500.0f, 1000.0f, 3000.0f, 5000.0f};
    private static final int StandardColor = Color.parseColor("#3498db");

    private static final int StandardFaceColor = Color.parseColor("#3F1F76");
    ...
    public Analogdisplay(final Context context, final AttributeSet attrs, final int defStyle) {
        super(context, attrs, defStyle);
        readAttrs(context, attrs, defStyle);
        init();
    }

    public Analogdisplay(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public Analogdisplay(final Context context) {
        this(context, null, 0);
    }

    private void readAttrs(final Context context, final AttributeSet attrs, final int defStyle) {
        final TypedArray a = context.obtainStyledAttributes(attrs, Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay, defStyle, 0);
        mShowOuterShadow = a.getBoolean(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_showOuterShadow, AussereSchatten);
        mShowOuterBorder = a.getBoolean(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_showOuterBorder, ShowOuterBorder);
        mShowOuterRim = a.getBoolean(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_showOuterRim, ShowOuterRim);
        mShowInnerRim = a.getBoolean(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_showInnerRim, ShowInerRim);
        mShowNeedle = a.getBoolean(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_showNeedle, ShowNedel);
        mShowScale = a.getBoolean(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_showScale, ShowScale);
        mShowRanges = a.getBoolean(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_showRanges, ShowRanges);
        mShowText = a.getBoolean(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_showRangeText, StandarsShowRangeValues);

        mOuterShadowWidth = mShowOuterShadow ? a.getFloat(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_outerShadowWidth, OuterShadomWidth) : 0.0f;
        mOuterBorderWidth = mShowOuterBorder ? a.getFloat(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_outerBorderWidth, OuterBorderWdith) : 0.0f;
        mOuterRimWidth = mShowOuterRim ? a.getFloat(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_outerRimWidth, OuterRimWidth) : 0.0f;
        mInnerRimWidth = mShowInnerRim ? a.getFloat(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_innerRimWidth, InnerRimWidth) : 0.0f;
        mInnerRimBorderWidth = mShowInnerRim ? a.getFloat(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_innerRimBorderWidth, InnerRimBorderWidth) : 0.0f;

        mNeedleWidth = a.getFloat(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_needleWidth, NedelWidth);
        mNeedleHeight = a.getFloat(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_needleHeight, NedleHeigh);
        mInnerCircleColor = a.getColor(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_innerCircleColor, InnercircelColor);
        mOuterCircleColor = a.getColor(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_outerCircleColor, OuterCircleColor);


        mScalePosition = (mShowScale || mShowRanges) ? a.getFloat(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_scalePosition, ScalePosition) : 0.0f;
        mScaleStartValue = a.getFloat(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_scaleStartValue, ScaleStartValue);
        mScaleEndValue = a.getFloat(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_scaleEndValue, ScaleEndValue);
        mScaleStartAngle = a.getFloat(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_scaleStartAngle, ScaleStartAngle);

        mDivisions = a.getInteger(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_divisions, ScaleDivision);
        mSubdivisions = a.getInteger(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_subdivisions, ScaleSubdivision);

        if (mShowRanges) {
            mTextShadowColor = a.getColor(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_textShadowColor, TextShadowColor);

            final CharSequence[] rangeValues = a.getTextArray(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_rangeValues);
            final CharSequence[] rangeColors = a.getTextArray(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_rangeColors);
            readRanges(rangeValues, rangeColors);
            mShowRangeValues = StandarsShowRangeValues;
        }

        if (mShowText) {
            final int textValueId = a.getResourceId(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_textValue, 0);
            final String textValue = a.getString(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_textValue);
            mTextValue = (0 < textValueId) ? context.getString(textValueId) : (null != textValue) ? textValue : "";

            final int textUnitId = a.getResourceId(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_Unit, 0);
            final String textUnit = a.getString(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_Unit);
            mTextUnit = (0 < textUnitId) ? context.getString(textUnitId) : (null != textUnit) ? textUnit : "";
            mTextValueColor = a.getColor(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_textValueColor, TextValueColor);
            mTextUnitColor = a.getColor(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_UnitColor, TextUnitColor);
            mTextShadowColor = a.getColor(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_textShadowColor, TextShadowColor);

            mTextValueSize = a.getFloat(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_textValueSize, TextValueSize);
            mTextUnitSize = a.getFloat(Display.ang.AnalogDisplay.Analoglib.R.styleable.AnalogDisplay_UnitSize, TextUnitSitze);
        }
    ...
    private void readRanges(final CharSequence[] rangeValues, final CharSequence[] rangeColors) {
        ...
        if (rangeValues == null) {
            rangeValuesLength = StandardRangeValue.length;
        } else {
        ...
        if (rangeValues != null) {
            ...
            mRangeValues = StandardRangeValue;
        }
    ...
    public void initDrawingRects() {
        ...
        mOuterShadowRect = new RectF(LEFT, Topline, RIGHT, BOTTOM);
...
//				TileMode.CLAMP));
    ...
    public Paint getDefaultFacePaint() {
        final Paint paint = new Paint(Paint.ANTI_ALIAS_FLAG);
        paint.setColor(StandardFaceColor);
        return paint;
    }
